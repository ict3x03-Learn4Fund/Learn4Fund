  ...
  return (
    <main>
      <div className="flex h-full w-full my-4">
        <div className="flex flex-row flex-wrap w-full mx-4 p-4">
          <div className="flex flex-col flex-wrap w-full text-[18px] font-bold">
            TITANS, TERMS OF USE
          </div>
          <div className="flex flex-col flex-wrap w-full text-[14px] font-bold">
            <p>Last Updated September 06, 2022</p>
          </div>
          <div className="flex flex-col flex-wrap w-full text-[16px] font-bold mt-4">
            1. AGREEMENT TO TERMS
          </div>
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behaf of an entity you) and
            Titans ("Company", we, "us", or "our"), conceming your access to and
            use of the leam4fund website as well as any other media form, media
            channel, mobile website or mobile application related, linked, or
            otherwise connected thereto (collectively, the "Site"). We are
            registered in Singapore and have our registered office at Singapore
            979797. You agree that by accessing the Site, you have read,
            ...
            may be posted on the Site rom time to time are hereby expressly
            ...
            Please ensure that you check the applicable Portability and
            ...
            way that would violate the Gramm- Leach-Biiley Act (GLBA). The Site
            ...
            supervised by, their parent or guardian to use the Site. you are a
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            and intermational conventions. The Content and the Marks are
            provided on the Site "AS IS" for your information and personal use
            only. Except as expressly provided in these Terms of Use, no part
            ofthe Site and no Content or Marks may be copied, reproduced,
            ...
            personal, non-commercial use. We reserve all ights not expressly
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            Site will not violate any applicable law or regulation. Ifyou
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            your account and password. We reserve the right to remove, rectaim,
            or change a username you select if we determine, in our sole
            discretion, that such usemame is inappropriate, obscene, or
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            or change a username you select if we determine, in our sole
            discretion, that such usemame is inappropriate, obscene, or
            otherwise objectionable. All products are subject to availability.
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            American Express You agree to provide current, complete, and
            ...
            time. All payments shall be in SGD. You agree to pay all charges at
            the prices then in effect for your purchases and any applicable
            shipping fees, and you authorize us to charge your chosen payment
            provider for any such amounts upon placing your order. If your order
            is subject to recurring charges, then you consent to our charging
            ...
            billing or shipping address. We reserve the right to mit or prohibit
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            agree not to: = Systematically retrieve data or other content from
            ...
            andior the Site. = Use any information obtained from the Site in
            ...
            misconduct. = Use the Site in a manner inconsistent with any
            applicable laws or regulations. = Engage in unauthorized framing of
            or linking to the Site. = Upload or transmit (or attempt fo upload
            ...
            limitation, clear graphics interchange formats (gis), 11 pixels, web
            ...
            in any way making up 2 part of the Site. Except as may be the result
            ...
            limitation, any spider, robot, cheat utity, scraper, or offine
            reader that accesses the Site, or using or launching any
            unauthorized script or other software. Use a buying agent or
            purchasing agent to make purchases on the Site Make any unauthorized
            use of the Site, including collecting usernames andlor email
            ...
            means or under false pretenses. Use the Site as part of any effort
          ...
          <div className="flex flex-col flex-wrap w-full text-[16px] font-bold mt-4">
            9. USER GENERATED CONTRIBUITONS
          </div>
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            third- arly websites. As such, any Contributions you transmit may be
            ...
            not obscene, lewd, lascivious, fithy, violent, harassing, libelous,
            ...
            applicable law or regulation. Any use of the Site or the Marketplace
            ...
            your rights to use the Site and the Marketplace Offerings.
          </div>
          <div className="flex flex-col flex-wrap w-full text-[16px] font-bold mt-4">
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            disclose, sel, resell, publish, broadcast, rettle, archive, store,
            ...
            Contributions, and rant and authorize sublicenses of the foregoing.
            ...
            exonerate us from any and all responsibilty and to refrain from any
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            (1) you should have firsthand experience with the personventity
            ...
            references to illegal activity: (5) you should not be affliated with
            ...
            represent our opinions or the views of any of our affliates or
            ...
            right and license to reproduce, modi, translate, transmit by any
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            Third-Party Account (the "Social Network Content") so that its
            ...
            your account on the Site. Please note that if @ Third-Party Account
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            Submissions for any laviul purpose, commercial or otherwise, without
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            offensiveness, opinions, reliabilty, privacy practices, or other
            ...
            Third-Party Websites willbe through other websites and from other
            companies, and we take no responsibilty whatsoever in relation to
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            reporting such user to law enforcement authorities; (2) in our sole
            ...
            and (5) otherwise manage the Site in @ manner designed to protect
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            in Singapore. If you access the Site or the Marketplace Offerings
            ...
            of the Site, you are transferring your data to Singapore, and you
            expressly consent to have your data transferred to and processed in
            Singapore. Further, we do not knowingly accept, request, or solicit
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            <br />
            fwe terminate or suspend your account for any reason, you are
            prohibited from registering and creating a new account under your
            name, a fake or borrowed name, or the name of any third party, even
            if you may be acting on behaff ofthe third party. In addition to
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            information on our Site. We also reserve the right to modity or
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            Singapore. Titans and yourself irrevocably consent that the courts
            of Singapore shall have exclusive jurisdiction to resolve any
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            the Singapore courts. Titans shall also maintain the right to bring
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            Marketplace Offerings, including descriptions, pricing, availabilty,
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            WEBSITES LINKED TO THIS SITE AND WE WILLASSUME NO LIABILITY OR
            ...
            BY ANY THIRD PARTY, ANDIOR (6) ANY ERRORS OR OMISSIONS IN ANY
            ...
            ADVERTISED OR OFFERED BY ATHIRD PARTY THROUGH THE SITE, ANY
            HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED
            IN ANY BANNER OR OTHER ADVERTISING, AND WE WILLNOT BE A PARTY TO OR
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            undertaken using the Site. You agree that we shall have no liabilty
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIATHE SITE.
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            65 97979797 or email us at learn4fund@titans.com
          </div>
        </div>
      </div>
    </main>
