      ...
      <div className="flex h-full w-full my-4">
        <div className="flex flex-row flex-wrap w-full mx-4 p-4">
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            set by the website owner (in this case, Learn4Fund) are called "first
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            ...
            advertising. If you would like to The specific types of first and
          ...
          <div className="flex flex-col flex-wrap w-full text-[14px]">
            Name: _GRECAPTCHA Purpose: Used to filter spam traffic and allow
            only legitimate visitors to use Learn4Fund's services. Provider:
            www.google.com Service: reCAPTCHA View Service Privacy Policy
            Country: United States Type: http_cookie Expires in: 5 months 27
            days
          </div>
        </div>
      </div>
