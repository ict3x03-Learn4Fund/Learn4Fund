...
const Banner = (props) => {
    ...
    return (
        <div className='sticky bottom-0 flex h-[80px] w-full bg-black opacity-80 justify-center' style={{zIndex: 49}}>
            ...
            <div className="cursor-pointer flex flex-col font-type1 font-bold text-[24px] self-center text-w1 w-fit h-fit    " onClick={()=>{props.setPromoModal(true)}}>More Discounts 4 Our Members! Find Out More.</div>
        </div>
